...
backbone= np.load('./Poolings/Backbone/train_pooled_backbone_atoms_March10_17-44.npy')
sidechain= np.load('./Poolings/SideChain/train_pooled_sidechain_atoms_March10_17-44.npy')

checkpoint=torch.load('./model_March10_17-44.ckpt', map_location=device)
...
model_backbone = DiffusionModel(k, hidden_dim, diffusion_steps, beta_start, beta_end,
                                schedule_type, denoiser_type, normalize=True,
...
torch.save(samples_backbone, './Gens_diffusion/mlpgenerated_backboneSSeq_March11_2.pt')
torch.save(samples_sidechain, './Gens_diffusion/mlpgenerated_sidechainSSeq_March11_2.pt')